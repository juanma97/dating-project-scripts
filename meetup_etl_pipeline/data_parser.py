...
def build_database_record(node: Dict, ai_data: Dict) -> Dict[str, Any]:
    ...
    record = {
        ...
        "description": clean_text(ai_data.get('description', '')) or "Unknown",
        "date": event_date,
        "time": event_time,
        ...
        "organizer": group_raw.get('name') or "Unknown",
        "source": "Meetup",
        ...
        "sexual_orientation": ai_data.get('sexual_orientation') or "Unknown",
